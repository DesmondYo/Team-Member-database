...
public class MemberDao {
	...
	private final String GET_MEMBER_BY_TEAM_ID_QUERY = "SELECT * FROM members WHERE team_id = ?";
	...
	public List<Member> getmembersByTeamId(int teamId) throws SQLException {
		PreparedStatement ps = connection.prepareStatement(GET_MEMBER_BY_TEAM_ID_QUERY);
		ps.setInt(1, teamId);
	...
	public void deleteMemberById(int teamId) throws SQLException {
